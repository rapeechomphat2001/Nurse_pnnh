<?php
// =====================================================================
//  ข่าวสารของแผนก — ลิสต์ข่าว/เกร็ดความรู้ (section: knowledge) เฉพาะแผนกที่เลือก
//  แยกออกจากข่าวประชาสัมพันธ์ส่วนกลางของหน้าแรก (ตาราง news / all_news.php)
// =====================================================================
...
// ---------- ข่าวสาร/เกร็ดความรู้ของแผนกนี้ (section: knowledge) ----------
$stmt = $conn->prepare("SELECT * FROM department_contents WHERE department_id = :id AND section = 'knowledge' ORDER BY sort_order ASC, id DESC");
$stmt->execute([':id' => $DEPT_ID]);
$news_rows = $stmt->fetchAll(PDO::FETCH_ASSOC);
...
<head>
    ...
    <title>ข่าวสารของแผนก<?= $dept ? ' ' . htmlspecialchars($dept['name']) : '' ?> - กลุ่มงานการพยาบาล โรงพยาบาลปากช่องนานา</title>
            ...
            <div class="navbar-nav"><div class="nav-item dropdown">
                ...
                <div class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="serviceDropdown">
                        <li><a class="dropdown-item" href="supervision_results.php?id=<?= (int)$DEPT_ID ?>"><i class="bi bi-clipboard2-check-fill me-2"></i> ผลการนิเทศ</a></li>
                    </ul>
                </div>
                ...
                <div class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="infoDropdown">
                        ...
                        <li><a class="dropdown-item" href="dashboard.php?id=<?= (int)$DEPT_ID ?>"><i class="bi bi-speedometer2 me-2"></i> Dashbord</a></li>
                    </ul>
                </div>
                ...
                <div class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="newsDropdown">
                        <li><a class="dropdown-item active" href="dept_news.php?id=<?= (int)$DEPT_ID ?>"><i class="bi bi-megaphone-fill me-2"></i> ข่าวสารของแผนก</a></li>
...
<div class="page-header">
    <div class="container d-flex justify-content-between align-items-center flex-wrap gap-2">
        <h1><i class="bi bi-megaphone-fill me-2"></i>ข่าวสารของแผนก</h1>
    </div>
</div>
...
<div class="container my-5">
    <div class="row justify-content-center">
        <div class="col-lg-9 col-xl-8">
            <?php if ($detailRow): ?>
                <a href="dept_news.php?id=<?= (int)$DEPT_ID ?>" class="btn-back mb-4 d-inline-flex"><i class="bi bi-arrow-left-circle-fill"></i> กลับไปหน้ารายการ</a>
            ...
            <?php elseif (!empty($news_rows)): ?>
                <div class="section-title"><i class="bi bi-megaphone-fill me-1"></i> รายการข่าวสารของแผนก</div>
                <div class="news-list-card">
                    <?php foreach ($news_rows as $row): ?>
                        <a href="?id=<?= (int)$DEPT_ID ?>&item=<?= (int)$row['id'] ?>" class="news-row">
