...
// หน้า _index (ไม่มี dept context) สำหรับ main admin เท่านั้น
// dept user → redirect ไปยังหน้าบริหารความเสี่ยงของแผนกตัวเอง
if ($_SESSION['role'] !== 'main') {
    $myDept = (int)$_SESSION['department_id'];
    header('Location: risk_management.php?id=' . $myDept);
    exit;
}
