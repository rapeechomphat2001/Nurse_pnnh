...
$detailRow = null;
if ($item_id > 0 && !empty($bySection['wi'])) {
    foreach ($bySection['wi'] as $r) {
...
<div class="container my-5">
    <div class="row justify-content-center">
        <div class="col-lg-9 col-xl-8">
            ...
            <?php elseif (!empty($bySection['wi'])): ?>
                <div class="section-title"><i class="bi bi-file-earmark-text-fill me-1"></i> รายการWI</div>
                <div class="news-list-card">
                    <?php foreach ($bySection['wi'] as $row): ?>
