...
$detailRow = null;
if ($item_id > 0 && !empty($bySection['service_profile'])) {
    foreach ($bySection['service_profile'] as $r) {
...
<div class="container my-5">
    <div class="row justify-content-center">
        <div class="col-lg-9 col-xl-8">
            ...
            <?php elseif (!empty($bySection['service_profile'])): ?>
                <div class="section-title"><i class="bi bi-file-earmark-person-fill me-1"></i> รายการService profile</div>
                <div class="news-list-card">
                    <?php foreach ($bySection['service_profile'] as $row): ?>
