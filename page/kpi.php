...
// ---------- เนื้อหาทั่วไป ----------
$gc_rows = $conn->query("SELECT * FROM department_contents WHERE department_id IS NULL AND section = 'kpi' ORDER BY sort_order ASC, id ASC")->fetchAll(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html lang="th">
<head>
...
<div class="container my-5">
    <div class="row justify-content-center">
        <div class="col-lg-9 col-xl-8" <?= $DEPT_ID === null ? 'id="generalContent"' : '' ?>>
            <?php if ($DEPT_ID !== null && !empty($bySection['kpi'])): ?>
                <div class="d-flex flex-column gap-4">
                    <?php foreach ($bySection['kpi'] as $row): ?>
