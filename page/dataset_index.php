...
$detailRow = null;
if ($item_id > 0 && !empty($bySection['dataset'])) {
    foreach ($bySection['dataset'] as $r) {
...
<div class="container my-5">
    <div class="row justify-content-center">
        <div class="col-lg-9 col-xl-8">
            ...
            <?php elseif (!empty($bySection['dataset'])): ?>
                <div class="section-title"><i class="bi bi-database-fill me-1"></i> รายการData set</div>
                <div class="news-list-card">
                    <?php foreach ($bySection['dataset'] as $row): ?>
