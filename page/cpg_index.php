...
$detailRow = null;
if ($item_id > 0 && !empty($bySection['cpg'])) {
    foreach ($bySection['cpg'] as $r) {
...
<div class="container my-5">
    <div class="row justify-content-center">
        <div class="col-lg-9 col-xl-8">
            ...
            <?php elseif (!empty($bySection['cpg'])): ?>
                <div class="section-title"><i class="bi bi-clipboard2-pulse-fill me-1"></i> รายการCNPG</div>
                <div class="news-list-card">
                    <?php foreach ($bySection['cpg'] as $row): ?>
