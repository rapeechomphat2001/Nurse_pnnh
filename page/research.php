...
$detailRow = null;
if ($item_id > 0 && !empty($bySection['research'])) {
    foreach ($bySection['research'] as $r) {
...
<div class="container my-5">
    <div class="row justify-content-center">
        <div class="col-lg-9 col-xl-8">
            ...
            <?php elseif (!empty($bySection['research'])): ?>
                <div class="section-title"><i class="bi bi-search me-1"></i> รายการวิจัย</div>
                <div class="news-list-card">
                    <?php foreach ($bySection['research'] as $row): ?>
