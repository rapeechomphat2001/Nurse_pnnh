...
.content-frame{
    ...
    padding:20px;          /* เดิม 30px 35px ลดลงเพราะเป็นรูป */
    height:100%;
    transition:all .35s ease;
    overflow:hidden;       /* ป้องกันรูปทะลุขอบ */
}
        ...
        <div class="row justify-content-center g-4">
            ...
            <div class="col-lg-5 px-2">
                <div class="content-frame">
                    <img src="../uploads/v2.png"
                        alt="วิสัยทัศน์และพันธกิจโรงพยาบาล"
                        class="img-fluid">
                </div>
            </div>
            ...
            <div class="col-lg-5 px-2">
                <div class="content-frame">
                    <img src="../uploads/v1.png"
                        alt="วิสัยทัศน์และพันธกิจฝ่ายการพยาบาล"
                        class="img-fluid">
                </div>
            </div>
