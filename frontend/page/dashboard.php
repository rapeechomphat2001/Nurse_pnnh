...
$detailRow = null;
if ($item_id > 0 && !empty($bySection['dashboard'])) {
    foreach ($bySection['dashboard'] as $r) {
...
<div class="container my-5">
    <div class="row justify-content-center">
        <div class="col-lg-9 col-xl-8">
            ...
            <?php elseif (!empty($bySection['dashboard'])): ?>
                <div class="section-title"><i class="bi bi-speedometer2 me-1"></i> รายการDashbord</div>
                <div class="news-list-card">
                    <?php foreach ($bySection['dashboard'] as $row): ?>
