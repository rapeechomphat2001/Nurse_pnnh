...
// ทำเนียบหัวหน้าพยาบาล — Grid รูป+ชื่อ+ตำแหน่ง เรียงตามลำดับความสำคัญ (sort_order)
$stmt_roster = $conn->query("SELECT * FROM department_contents WHERE department_id IS NULL AND section = 'nurse_roster' ORDER BY sort_order ASC, id ASC");
