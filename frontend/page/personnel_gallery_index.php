            ...
            <div class="navbar-nav">
                ...
                <div class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="aboutDropdown">
                        ...
                        <li><a class="dropdown-item" href="<?= $DEPT_ID ? 'personnel_gallery_index.php?id='.(int)$DEPT_ID : 'personnel_gallery_index.php' ?>"><i class="bi bi-people-fill me-2 "></i> รูปบุคลากร</a></li>
                    </ul>
                </div>
                ...
                <div class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="qualityDropdown">
                        ...
                        <li><a class="dropdown-item" href="research.php"><i class="bi bi-search me-2"></i> วิจัย/CQI</a></li>
                    </ul>
                </div>
