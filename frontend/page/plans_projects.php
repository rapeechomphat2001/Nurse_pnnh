...
// ---------- เนื้อหาทั่วไป ----------
$gc_rows = $conn->query("SELECT * FROM department_contents WHERE department_id IS NULL AND section = 'plans_projects' ORDER BY sort_order ASC, id ASC")->fetchAll(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html lang="th">
<head>
